...
#define CLIENTTABLE_SHMKEY ((key_t) 7771) /* base value for shmclientTable key */
#define IDTABLE_SHMKEY ((key_t) 7772) /* base value for shmidTable key */
#define MSGBUFFER_SHMKEY ((key_t) 7773) /* base value for msgbuffer key */
#define PERMS 0666
#define QLEN 5
#define BUFSIZE 4096
